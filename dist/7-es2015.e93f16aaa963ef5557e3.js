              ...
              component: (() => {
                let e = class {
                  ...
                  generateTeammateToken(e) {
                    return Object(O.a)(this, void 0, void 0, function* () {
                      const { token: t } = yield this._gamesService.generateTeammateToken({
                        id: e,
                          ...
                          return (
                            'string' == typeof t
                              ? (function (e, t, a) {
                                  ...
                                  if (!1 === V(s))
                                    throw new Error(
                                      `${e.constructor.name} is using untilDestroyed but doesn't implement ${t}`
                                    );
                                  $(e, a),
                                    (e[t] = function () {
                ...
                return (
                  ...
                  (e.ɵcmp = i.Pb({
                    ...
                    template: function (e, t) {
                      1 & e && i.Kc(0, ae, 3, 2, 'ng-container', 0), 2 & e && i.vc('ngIf', t.player);
                    },
                    directives: [k.l, te.a, N.a],
                    styles: [
