          ...
          return (
            'string' == typeof t
              ? (function (e, t, a) {
                  ...
                  if (!1 === K(n))
                    throw new Error(
                      ''.concat(e.constructor.name, " is using untilDestroyed but doesn't implement ").concat(t)
                    );
                  ee(e, a),
                    (e[t] = function () {
                      K(n) && n.apply(this, arguments), te(this, a), (e[t] = n);
                    });
                })(e, t, n)
              : ((function (e) {
      ...
      var oe,
        ...
        ce =
          (((oe = (function () {
            ...
            return (
              _createClass(e, [
                ...
                },
                {
                  ...
                  value: function () {
                    var e = this;
                    this._activatedRoute.params.pipe(re(this)).subscribe(function (t) {
                      return Object(R.a)(
                        e,
                        void 0,
                        void 0,
                            ...
                            function (e) {
                              for (;;)
                                switch ((e.prev = e.next)) {
                                  ...
                                  case 4:
                                    (this.player = e.sent), (this.tabs = this.getTabs());
                                  case 6:
                                  case 'end':
                                    return e.stop();
                                }
            ...
            return new (e || oe)(d.Vb(s.a), d.Vb(W.c), d.Vb(W.b), d.Vb(U.a), d.Vb(o.e));
          }),
          (oe.ɵcmp = d.Pb({
            type: oe,
            ...
            template: function (e, t) {
              1 & e && d.Kc(0, _e, 3, 2, 'ng-container', 0), 2 & e && d.vc('ngIf', t.player);
            },
            directives: [D.l, de.a, V.a],
            styles: [
        ...
        ye = [
          {
            ...
            children: [
              ...
              { path: r.a.QUIZ_PLAYER.path, component: ce },
              {
                path: r.a.TEMPLATES.path,
                component:
                  ((ue = (function () {
                    function e(t) {
                      _classCallCheck(this, e), (this._httpClient = t), (this.tabs = this.getTabs());
                    }
                    return (
                      _createClass(e, [
                        {
                        ...
                        },
                        {
                          key: 'onGameUpdate',
                          value: function (e) {
                            for (var t = new FormData(), a = 0; a < e.file.files.length; a++)
                              t.append('files', e.file.files[a]);
                            this._httpClient
                              .post(z.a.apiUrl + 'templates', t)
                              .pipe(Object(Me.a)(1), re(this))
                              .subscribe(function (e) {
                                console.log(e);
                              });
                          },
