  ...
  [7],
  {
    '+cuU': function (e, t, a) {
          ...
          ngOnInit() {
            (this.showTitle = this._appConfigsService.get('sidebar')),
              this._breakpointObserver
                ...
                .pipe(Object(r.a)(this._ngOnDestory$))
                .subscribe((e) => this.toogleMode(e.matches));
          }
        }
        return (
          (e.ɵfac = function (t) {
            return new (t || e)(i.Vb(d.b), i.Vb(m.a), i.Vb(_.b));
          }),
          (e.ɵcmp = i.Pb({
            type: e,
            ...
            viewQuery: function (e, t) {
              var a;
              1 & e && i.Rc(M, !0), 2 & e && i.Ac((a = i.kc())) && (t.sidenav = a.first);
            },
            ...
            template: function (e, t) {
              1 & e &&
                (i.uc(L),
                i.bc(0, 'mat-sidenav-container', 0),
                i.bc(1, 'mat-sidenav', 1, 2),
                i.bc(3, 'app-sidenav', 3),
                i.jc('burgerClicked', function () {
                ...
                2 & e &&
                  (i.Ib(1),
                  i.vc('mode', t.mode)('opened', t.isOpen),
                  i.Ib(2),
                  i.vc('navLinks', t.navLinks)('showTitle', t.showTitle),
                  i.Ib(3),
                  i.vc('showBurger', t.showBurger));
            },
            directives: [l.b, l.a, c.a, l.c, h.a],
            styles: [
      ...
      function D(e, t) {
        if (1 & e) {
          ...
          i.bc(0, 'button', 7),
            i.jc('click', function () {
              i.Dc(e);
              const a = t.$implicit;
              return i.nc().onLanguageChange(a);
            }),
            i.Mc(1),
            i.oc(2, 'translate'),
            i.oc(3, 'uppercase'),
        ...
        if (2 & e) {
          const e = t.$implicit;
          i.Ib(1), i.Oc(' ', i.pc(2, 1, i.pc(3, 3, 'LANGUAGES.' + e)), ' ');
        }
      }
      let g = (() => {
        class e {
          ...
          ngOnInit() {
            ...
            const e = Object.values(n.a);
            (this.navLinks = e.filter((e) => e.inNav)),
              (this.user$ = this._authService.user$),
              this._translateService.onLangChange.pipe(Object(r.a)(this._ngOnDestroy$)).subscribe(({ lang: e }) => {
                (this.acitveLanguage = e), this._appConfigsService.set('language', e);
              });
          }
        }
        return (
          (e.ɵfac = function (t) {
            return new (t || e)(i.Vb(d.b), i.Vb(_.g), i.Vb(o.e), i.Vb(_.b));
          }),
          (e.ɵcmp = i.Pb({
            type: e,
            selectors: [['app-admin']],
            ...
            template: function (e, t) {
              if (
                (1 & e &&
                  (i.Wb(0, 'ng-progress', null, 0),
                  i.bc(2, 'app-layout-1', 1),
                  i.jc('exitClicked', function () {
                    return t.onExit();
                  }),
                  i.bc(3, 'div', 2),
                  i.bc(4, 'button', 3),
                  ...
                  i.oc(7, 'uppercase'),
                  i.ac(),
                  i.bc(8, 'mat-menu', null, 4),
                  i.Kc(10, D, 4, 5, 'button', 5),
                  i.ac(),
                  i.ac(),
                  i.Wb(11, 'router-outlet', 6),
                  i.ac()),
                2 & e)
              ) {
                const e = i.Bc(9);
                i.Ib(2),
                  i.vc('navLinks', t.navLinks),
                  i.Ib(2),
                  i.vc('matMenuTriggerFor', e),
                  i.Ib(1),
                  i.Oc(' ', i.pc(6, 4, i.pc(7, 6, 'LANGUAGES.' + t.acitveLanguage)), ' '),
                  i.Ib(5),
                  i.vc('ngForOf', t.languages);
              }
            },
            directives: [u.a, y, f.a, p.c, p.d, k.k, s.g, p.a],
            pipes: [o.d, k.u],
            styles: [
      ...
      let x = (() => {
        class e {
          constructor(e, t, a, s) {
            (this._activatedRoute = e), (this._ngOnDestroy$ = t), (this._authService = a), (this._gamesService = s);
          }
          onAddClick() {
          ...
          ngOnInit() {
            (this.type = this._activatedRoute.snapshot.data.type),
              ...
              (this.searchInput = new w.e('')),
              (this.games$ = this.searchInput.valueChanges.pipe(
                Object(T.a)(''),
                Object(r.a)(this._ngOnDestroy$),
                Object(v.a)(300),
                Object(b.a)(),
                Object(S.a)((e) =>
                  this._gamesService.getMany$({
                    filter: { owner: this._authService.user.id, type: this.type, name: e },
                  })
                )
              ));
          }
        ...
        return (
          (e.ɵfac = function (t) {
            return new (t || e)(i.Vb(s.a), i.Vb(d.b), i.Vb(_.g), i.Vb(H.b));
          }),
          (e.ɵcmp = i.Pb({
            type: e,
            ...
            template: function (e, t) {
              1 & e &&
                ...
                i.oc(1, 'async'),
                i.ac()),
                2 & e && i.vc('items', i.pc(1, 2, t.games$))('fabTrigger', t.fabTrigger);
            },
            directives: [j.a],
            pipes: [k.b],
            styles: [''],
      ...
      let C = (() => {
          class e {
            constructor(e, t, a, s, n, r, i) {
              (this._ngOnDestroy$ = e),
                ...
                (this._gamesService = a),
                (this._roundsService = s),
                (this._appNotificationsService = n),
                (this._clipboard = r),
                (this._router = i);
            }
            onAddRound() {
              const e = `${this.type}_round`;
            ...
            onGameDelete(e) {
              return Object(O.a)(this, void 0, void 0, function* () {
                yield this._gamesService.removeOne({ id: e.id }),
                  this._router.navigate([n.a[e.type === R.QUIZ ? 'QUIZZES' : 'QUESTS'].fullPath]);
              });
            }
            onGameUpdate(e, t) {
            ...
            onAccessToogle(e, t) {
              return Object(O.a)(this, void 0, void 0, function* () {
                yield this._gamesService.giveAccess({ game: e, user: t }),
                  this._appNotificationsService.showSuccess(
                    '\u0414\u043e\u0441\u0442\u0443\u043f',
            ...
            generatePlayerToken(e) {
              return Object(O.a)(this, void 0, void 0, function* () {
                const { token: t } = yield this._gamesService.generatePlayerToken({ id: e.id });
                this._clipboard.copy(t),
                  this._appNotificationsService.showSuccess(
            ...
            onLinkCopy(e) {
              this._clipboard.copy(`${W.a.serverUrl}${n.a.QUEST.fullPath.replace(':id', e.id)}`),
                this._appNotificationsService.showSuccess(
            ...
            getTabs(e, t) {
              return Object(O.a)(this, void 0, void 0, function* () {
                const a = {
                    name: 'SETTINGS',
                    component: A.b,
                    inputs: { fields: `${e}_settings`, model: t },
                    outputs: { submited: (e) => this.onGameUpdate(t, e), deleted: () => this.onGameDelete(t) },
                  },
                  s = {
                    name: 'ROUNDS',
                    component: A.c,
                    inputs: { items$: this.rounds$, fabTrigger: { icon: 'add', func: () => this.onAddRound() } },
                    outputs: {
                      sorted: (e) => this._roundsService.sort(e),
                      clicked: (e) => this._roundsService.navigateToRound(t, e),
                    },
                  },
                  r = {
                    name: 'PLAYERS',
                    ...
                    inputs: {
                      ...
                      rows: t.players
                        .filter((e) => e.role.includes('leader'))
                        .map((e) => {
                          var t, a, s;
                          const n = e.history.filter((e) => 'hint' === e.action).length,
                            r =
                              null === (t = e.history.find((e) => 'start_game' === e.action)) || void 0 === t
                                ? void 0
                                : t.date,
                            i =
                              null === (a = e.history.find((e) => 'exit_game' === e.action)) || void 0 === a
                                ? void 0
                                : a.date,
                            d = F(r),
                            _ = F(i),
                          ...
                          return {
                            token: e.id,
                            name: null === (s = e.user) || void 0 === s ? void 0 : s.name,
                            hints: n,
                            time: `${i ? 'Finished' : 'Still in game'} ${o}:${u}:${m}`,
                          };
                        }),
                    },
                    outputs: {
                      ...
                      activated: (e) => {
                        'click' === e.type &&
                          this._router.navigateByUrl(
                            n.a.QUIZ_PLAYER.fullPath.replace(':gameId', this.game.id).replace(':playerId', e.row.token)
                          );
                      },
                    },
                  },
                      ...
                      actions: [
                        {
                          ...
                          color: 'primary',
                          onClick: () => this.generatePlayerToken(t),
                        },
                      ],
                    },
                  },
                  d = this._gamesService.getOne$({ id: t.id });
                return [
                  s,
                  ...{
                    [R.QUIZ]: [
                      {
                        ...
                        component: A.c,
                        inputs: {
                          items$: Object(P.a)([this.rounds$, d]).pipe(
                            Object(E.a)(([e, t]) =>
                              e.map((e) =>
                                t.activeRound === e.id ? Object.assign(Object.assign({}, e), { isActive: !0 }) : e
                              )
                            )
                          ),
                        },
                    ...
                    [R.QUEST]: [
                      {
                        ...
                        outputs: { submited: (e) => this._gamesService.updateOne({ id: t.id, changes: e }) },
                      },
                    ],
                  }[e],
                  i,
            ...
            ngOnInit() {
              return Object(O.a)(this, void 0, void 0, function* () {
                (this.gameForm = new w.g({})),
                  this._activatedRoute.params.pipe(Object(r.a)(this._ngOnDestroy$)).subscribe((e) =>
                    Object(O.a)(this, void 0, void 0, function* () {
                      const t = e.id;
                      (this.type = this._activatedRoute.snapshot.data.type),
                        (this.game = yield this._gamesService.getOne({ id: t })),
                        (this.rounds$ = this._roundsService
                          .getMany$({ filter: { game: t } })
                          .pipe(Object(E.a)((e) => e.sort((e, t) => e.order - t.order)))),
                        (this.tabs = yield this.getTabs(this.type, this.game));
                    })
                  );
              });
            }
          ...
          return (
            (e.ɵfac = function (t) {
              return new (t || e)(i.Vb(d.b), i.Vb(s.a), i.Vb(H.b), i.Vb(H.e), i.Vb(_.e), i.Vb(z.a), i.Vb(s.c));
            }),
            (e.ɵcmp = i.Pb({
              type: e,
              ...
              consts: [[3, 'tabs']],
              template: function (e, t) {
                1 & e && i.Wb(0, 'app-tabs', 0), 2 & e && i.vc('tabs', t.tabs);
              },
              directives: [N.a],
              styles: [''],
            })),
        ...
        J = (() => {
          class e {
            constructor(e, t, a, s, n) {
              (this._ngOnDestroy$ = e),
                (this._activatedRoute = t),
                (this._roundsService = a),
                (this._questionsService = s),
                (this._router = n),
                (this.getAddTitle = () => this.type.toLocaleUpperCase() + '.ADD');
            }
            onAddQuestion() {
              const e = `${this.type}_round_question`;
            ...
            onUpdateQuestion(e) {
              const t = `${this.type}_round_question`;
              this._questionsService.openPopupAndUpdateOne({ model: e, translateTitle: t.toUpperCase(), fields: t });
            }
            onRoundDelete({ id: e, game: t }) {
              return Object(O.a)(this, void 0, void 0, function* () {
                yield this._roundsService.removeOne({ id: e }),
                  this._router.navigate([n.a[t.type.toUpperCase()].fullPath.replace(':id', t.id)]);
              });
            }
            getTabs(e) {
              return Object(O.a)(this, void 0, void 0, function* () {
                const { round: t, type: a } = e;
                return [
                  {
                    name: 'QUESTIONS',
                    component: A.c,
                    inputs: {
                      items$: this.questions$.pipe(Object(E.a)((e) => e.sort((e, t) => e.order - t.order))),
                      fabTrigger: { icon: 'add', func: () => this.onAddQuestion() },
                    },
                    outputs: {
                      sorted: (e) => this._questionsService.sort(e),
                    ...
                    [R.QUEST]: [
                      {
                        name: 'ANSWER',
                        component: A.b,
                        inputs: { fields: `${a}_round_answer`, model: t },
                        outputs: { submited: (e) => this._roundsService.updateOne({ id: t.id, changes: e }) },
                      },
                      {
                        name: 'HINTS',
                        component: A.b,
                        inputs: { model: t, fields: 'quest_round_hints' },
                        outputs: { submited: (e) => this._roundsService.updateOne({ id: t.id, changes: e }) },
                      },
                    ],
                  }[a],
                  {
                    name: 'SETTINGS',
                    component: A.b,
                    inputs: { fields: `${a}_round_settings`, model: t },
                    outputs: {
                      submited: (e) => this._roundsService.updateOne({ id: t.id, changes: e }),
                      deleted: () => this.onRoundDelete({ id: t.id, game: { type: a, id: t.game.id } }),
                    },
                  },
                ];
              });
              ...
              return Object(O.a)(this, void 0, void 0, function* () {
                this._activatedRoute.params.pipe(Object(r.a)(this._ngOnDestroy$)).subscribe((e) =>
                  Object(O.a)(this, void 0, void 0, function* () {
                    const t = e.roundId;
                    (this.type = this._activatedRoute.snapshot.data.type),
                      (this.round = yield this._roundsService.getOne({ id: t })),
                      (this.questions$ = this._questionsService.getMany$({ filter: { round: t } })),
                      (this.tabs = yield this.getTabs({ round: this.round, type: this.type }));
                  })
                );
              });
            }
          ...
          return (
            (e.ɵfac = function (t) {
              return new (t || e)(i.Vb(d.b), i.Vb(s.a), i.Vb(H.e), i.Vb(H.d), i.Vb(s.c));
            }),
            (e.ɵcmp = i.Pb({
              type: e,
      ...
      const G = Symbol('__destroy'),
        Q = Symbol('__decoratorApplied');
      function B(e) {
        return 'string' == typeof e ? Symbol(`__destroy__${e}`) : G;
      }
      function $(e, t) {
        e[t] || (e[t] = new I.a());
      }
      ...
      function K(e) {
        e && V(e.unsubscribe) && e.unsubscribe();
      }
      function q(e, t) {
        return function () {
          var a, s;
          if ((e && e.call(this), Z(this, B()), t.arrayName))
            return (s = this[t.arrayName]), void (Array.isArray(s) && s.forEach(K));
          if (t.checkProperties)
            for (const e in this) (null === (a = t.blackList) || void 0 === a ? void 0 : a.includes(e)) || K(this[e]);
        };
      }
      function X(e = {}) {
        return (t) => {
          t[U]
            ? (function (e, t) {
                const a = e.ɵpipe;
                a.onDestroy = q(a.onDestroy, t);
              })(t, e)
            : (function (e, t) {
                e.prototype.ngOnDestroy = q(e.prototype.ngOnDestroy, t);
              })(t, e),
            (function (e) {
              e.prototype[Q] = !0;
            })(t);
          ...
          return (
            'string' == typeof t
              ? (function (e, t, a) {
                  const s = e[t];
                  if (!1 === V(s))
                    throw new Error(`${e.constructor.name} is using untilDestroyed but doesn't implement ${t}`);
                  $(e, a),
                    (e[t] = function () {
                      V(s) && s.apply(this, arguments), Z(this, a), (e[t] = s);
                    });
                })(e, t, s)
              : ((function (e) {
      ...
      var te = a('eEy1'),
        ae = a('iQeY');
      function se(e, t) {
        if ((1 & e && (i.Zb(0), i.Wb(1, 'app-typography', 1), i.Wb(2, 'app-tabs', 2), i.Yb()), 2 & e)) {
          const e = i.nc();
          i.Ib(1),
            i.vc(
              'data',
      ...
      let ne = (() => {
        let e = class {
            ...
            return [
              {
                ...
                inputs: {
                  ...
                  rows: this.player.history.map((e) =>
                    Object.assign(Object.assign({}, e), { date: F(e.date).format('MMMM Do YYYY, h:mm:ss a') })
                  ),
                },
              },
              {
              ...
              },
              {
                ...
                inputs: {
                  ...
                  rows: this.player.team.map((e) => {
                    var t, a;
                    return {
                      token: e.id,
                      name:
                        null === (a = null === (t = e.leader) || void 0 === t ? void 0 : t.user) || void 0 === a
                          ? void 0
                          : a.name,
                    };
                  }),
          ...
          generateTeammateToken(e) {
            return Object(O.a)(this, void 0, void 0, function* () {
              const { token: t } = yield this._gamesService.generateTeammateToken({ id: e, userId: this.player.id });
              this._clipboard.copy(t),
                this._appNotificationsService.showSuccess(
                  '\u0422\u043e\u043a\u0435\u043d \u0441\u0433\u0435\u043d\u0435\u0440\u0438\u0440\u043e\u0432\u0430\u043d \u0438 \u0441\u043a\u043e\u043f\u0438\u0440\u043e\u0432\u0430\u043d'
                );
          ...
          ngOnInit() {
            this._activatedRoute.params.pipe(ee(this)).subscribe((e) =>
              Object(O.a)(this, void 0, void 0, function* () {
                const t = e.playerId;
                (this.gameId = e.gameId),
                  (this.player = yield this._playersService.getOne({ id: t })),
        ...
        return (
          (e.ɵfac = function (t) {
            return new (t || e)(i.Vb(s.a), i.Vb(H.c), i.Vb(H.b), i.Vb(z.a), i.Vb(_.e));
          }),
          (e.ɵcmp = i.Pb({
            type: e,
            ...
            template: function (e, t) {
              1 & e && i.Kc(0, se, 3, 2, 'ng-container', 0), 2 & e && i.vc('ngIf', t.player);
            },
            directives: [k.l, ae.a, N.a],
            styles: [
      ...
      const _e = [
        {
          ...
          component: g,
          children: [
            { path: '', redirectTo: n.a.QUESTS.path, pathMatch: 'full' },
            { path: n.a.QUESTS.path, component: x, data: { type: R.QUEST } },
            { path: n.a.QUEST.path, component: C, data: { type: R.QUEST } },
            { path: n.a.QUEST_ROUND.path, component: J, data: { type: R.QUEST } },
            { path: n.a.QUIZZES.path, component: x, data: { type: R.QUIZ } },
            { path: n.a.QUIZ.path, component: C, data: { type: R.QUIZ } },
            { path: n.a.QUIZ_ROUND.path, component: J, data: { type: R.QUIZ } },
            { path: n.a.QUIZ_PLAYER.path, component: ne },
            {
              path: n.a.TEMPLATES.path,
              component: (() => {
                let e = class {
                  constructor(e) {
                    (this._httpClient = e), (this.tabs = this.getTabs());
                  }
                  getTabs() {
                    return [
                      {
                        ...
                        component: re.e,
                        inputs: { fields: ['file'] },
                        outputs: { submited: (e) => this.onGameUpdate(e) },
                      },
                      {
                  ...
                  onGameUpdate(e) {
                    ...
                    for (let a = 0; a < e.file.files.length; a++) t.append('files', e.file.files[a]);
                    this._httpClient
                      .post(W.a.apiUrl + 'templates', t)
                      .pipe(Object(ie.a)(1), ee(this))
                      .subscribe((e) => {
                        console.log(e);
                      });
                  }
                ...
                return (
                  (e.ɵfac = function (t) {
                    return new (t || e)(i.Vb(de.b));
                  }),
                  (e.ɵcmp = i.Pb({
                    type: e,
                    selectors: [['app-admin-templates']],
                    decls: 1,
                    vars: 1,
                    consts: [[3, 'tabs']],
                    template: function (e, t) {
      ...
      !(function (e) {
        ...
        function a(e, a, s, n) {
          ...
          switch (s) {
            ...
            case 'ss':
              return t(e) ? r + (a || n ? 'sek\xfandur' : 'sek\xfandum') : r + 'sek\xfanda';
            case 'm':
              return a ? 'm\xedn\xfata' : 'm\xedn\xfatu';
            case 'mm':
              return t(e)
                ? r + (a || n ? 'm\xedn\xfatur' : 'm\xedn\xfatum')
                : a
                ? r + 'm\xedn\xfata'
                : r + 'm\xedn\xfatu';
            case 'hh':
            ...
            case 'MM':
              return t(e)
                ? a
                  ? r + 'm\xe1nu\xf0ir'
                  : r + (n ? 'm\xe1nu\xf0i' : 'm\xe1nu\xf0um')
                : a
                ? r + 'm\xe1nu\xf0ur'
                : r + (n ? 'm\xe1nu\xf0' : 'm\xe1nu\xf0i');
            case 'y':
              return a || n ? '\xe1r' : '\xe1ri';
            case 'yy':
              return t(e) ? r + (a || n ? '\xe1r' : '\xe1rum') : r + (a || n ? '\xe1r' : '\xe1ri');
          }
        }
        e.defineLocale('is', {
    ...
    PA2r: function (e, t, a) {
      !(function (e) {
        ...
        function i(e, t, a, s) {
          ...
          switch (a) {
            case 's':
              return t || s ? 'p\xe1r sekund' : 'p\xe1r sekundami';
            case 'ss':
            ...
            case 'd':
              return t || s ? 'den' : 'dnem';
            case 'dd':
              return t || s ? n + (r(e) ? 'dny' : 'dn\xed') : n + 'dny';
            case 'M':
              return t || s ? 'm\u011bs\xedc' : 'm\u011bs\xedcem';
            case 'MM':
              return t || s ? n + (r(e) ? 'm\u011bs\xedce' : 'm\u011bs\xedc\u016f') : n + 'm\u011bs\xedci';
            case 'y':
    ...
    WxRl: function (e, t, a) {
      !(function (e) {
        ...
        function a(e, t, a, s) {
          ...
          switch (a) {
            case 's':
              return s || t ? 'n\xe9h\xe1ny m\xe1sodperc' : 'n\xe9h\xe1ny m\xe1sodperce';
            case 'ss':
              return n + (s || t) ? ' m\xe1sodperc' : ' m\xe1sodperce';
            case 'm':
              return 'egy' + (s || t ? ' perc' : ' perce');
            case 'mm':
              return n + (s || t ? ' perc' : ' perce');
            case 'h':
              return 'egy' + (s || t ? ' \xf3ra' : ' \xf3r\xe1ja');
            case 'hh':
              return n + (s || t ? ' \xf3ra' : ' \xf3r\xe1ja');
            case 'd':
              return 'egy' + (s || t ? ' nap' : ' napja');
            case 'dd':
              return n + (s || t ? ' nap' : ' napja');
            case 'M':
              return 'egy' + (s || t ? ' h\xf3nap' : ' h\xf3napja');
            case 'MM':
              return n + (s || t ? ' h\xf3nap' : ' h\xf3napja');
            case 'y':
              return 'egy' + (s || t ? ' \xe9v' : ' \xe9ve');
            case 'yy':
              return n + (s || t ? ' \xe9v' : ' \xe9ve');
          }
          return '';
        }
        function s(e) {
      ...
      !(function (e) {
        ...
        function n(e, t, a, n) {
          ...
          switch (a) {
            ...
            case 'ss':
              return t || n ? r + (s(e) ? 'sekundy' : 'sek\xfand') : r + 'sekundami';
            case 'm':
              return t ? 'min\xfata' : n ? 'min\xfatu' : 'min\xfatou';
            case 'mm':
              return t || n ? r + (s(e) ? 'min\xfaty' : 'min\xfat') : r + 'min\xfatami';
            case 'h':
              return t ? 'hodina' : n ? 'hodinu' : 'hodinou';
            case 'hh':
              return t || n ? r + (s(e) ? 'hodiny' : 'hod\xedn') : r + 'hodinami';
            case 'd':
              return t || n ? 'de\u0148' : 'd\u0148om';
            case 'dd':
              return t || n ? r + (s(e) ? 'dni' : 'dn\xed') : r + 'd\u0148ami';
            case 'M':
        ...
        e.exports = (function () {
          ...
          function J(e) {
            var t,
              a,
              s = {};
            for (a in e) d(e, a) && (t = C(a)) && (s[t] = e[a]);
            return s;
          }
          var I = {};
          function U(e, t) {
          ...
          function B(e, t) {
            return function (a) {
              return null != a ? (Z(this, e, a), n.updateOffset(this, t), this) : $(this, e);
            };
          }
          function $(e, t) {
          ...
          function Se(e, t, a) {
            ...
            return a
              ? 'MMM' === t
                ? -1 !== (n = Ye.call(this._shortMonthsParse, i))
                  ? n
                  : null
                : -1 !== (n = Ye.call(this._longMonthsParse, i))
                ? n
                : null
              : 'MMM' === t
              ? -1 !== (n = Ye.call(this._shortMonthsParse, i)) || -1 !== (n = Ye.call(this._longMonthsParse, i))
                ? n
                : null
              : -1 !== (n = Ye.call(this._longMonthsParse, i)) || -1 !== (n = Ye.call(this._shortMonthsParse, i))
              ? n
              : null;
          }
          function He(e, t) {
          ...
          function je(e) {
            return null != e ? (He(this, e), n.updateOffset(this, !0), this) : $(this, 'Month');
          }
          function xe() {
            function e(e, t) {
          ...
          function We(e, t, a, s, n, r, i) {
            ...
            return (
              e < 100 && e >= 0
                ? ((d = new Date(e + 400, t, a, s, n, r, i)), isFinite(d.getFullYear()) && d.setFullYear(e))
          ...
          function Re(e, t, a, s, n) {
            var r,
              i,
              d = 1 + 7 * (t - 1) + ((7 + a - s) % 7) + Ee(e, s, n);
            return (
          ...
          function Fe(e, t, a) {
            ...
            return (
              i < 1
                ? (s = i + ze((n = e.year() - 1), t, a))
                : i > ze(e.year(), t, a)
                ? ((s = i - ze(e.year(), t, a)), (n = e.year() + 1))
                : ((n = e.year()), (s = i)),
              { week: s, year: n }
            );
          }
          ...
          function Qe(e, t, a) {
            ...
            return a
              ? 'dddd' === t
                ? -1 !== (n = Ye.call(this._weekdaysParse, i))
                  ? n
                  : null
                : 'ddd' === t
                ? -1 !== (n = Ye.call(this._shortWeekdaysParse, i))
                  ? n
                  : null
                : -1 !== (n = Ye.call(this._minWeekdaysParse, i))
                ? n
                : null
              : 'dddd' === t
              ? -1 !== (n = Ye.call(this._weekdaysParse, i)) ||
          ...
          E('H', ['HH', 2], 0, 'hour'),
            ...
            fe('hmm', function (e, t, a) {
              var s = e.length - 2;
              (t[3] = Q(e.substr(0, s))), (t[4] = Q(e.substr(s))), (M(a).bigHour = !0);
            }),
            fe('hmmss', function (e, t, a) {
              var s = e.length - 4,
                n = e.length - 2;
              (t[3] = Q(e.substr(0, s))), (t[4] = Q(e.substr(s, 2))), (t[5] = Q(e.substr(n))), (M(a).bigHour = !0);
            }),
            fe('Hmm', function (e, t, a) {
              var s = e.length - 2;
            ...
            fe('Hmmss', function (e, t, a) {
              var s = e.length - 4,
                n = e.length - 2;
              (t[3] = Q(e.substr(0, s))), (t[4] = Q(e.substr(s, 2))), (t[5] = Q(e.substr(n)));
            });
          var qe,
            Xe = B('Hours', !0),
            et = {
          ...
          function _t(e) {
            ...
            return (function (e) {
              for (var t, a, s, n, r = 0; r < e.length; ) {
                for (t = (n = nt(e[r]).split('-')).length, a = (a = nt(e[r + 1])) ? a.split('-') : null; t > 0; ) {
                    ...
                    (function (e) {
                      ...
                      null != (t = e._w).GG || null != t.W || null != t.E
                        ...
                        s < 1 || s > ze(a, r, i)
                          ...
                          : ((d = Re(a, s, n, r, i)), (e._a[0] = d.year), (e._dayOfYear = d.dayOfYear));
                    })(e),
                  null != e._dayOfYear &&
                    ((i = pt(e._a[0], s[0])),
            ...
            if (e._f !== n.ISO_8601)
              if (e._f !== n.RFC_2822) {
                ...
                var t,
                  ...
                  o = _.length,
                  u = 0;
                for (s = F(e._f, e._locale).match(O) || [], t = 0; t < s.length; t++)
                  (a = (_.match(Me((r = s[t]), e)) || [])[0]) &&
                ...
                (M(e).charsLeftOver = o - u),
                  ...
                  (e._a[3] = (function (e, t, a) {
                    ...
                    return null == a
                      ...
                      ? e.meridiemHour(t, a)
                      : null != e.isPM
                      ? ((s = e.isPM(a)) && t < 12 && (t += 12), s || 12 !== t || (t = 0), t)
                      : t;
          ...
          function jt(e) {
            ...
            (this._isValid = (function (e) {
              ...
              for (a = 0; a < Ht.length; ++a)
                if (e[Ht[a]]) {
                  if (s) return !1;
                  parseFloat(e[Ht[a]]) !== Q(e[Ht[a]]) && (s = !0);
                }
              return !0;
            })(t)),
          ...
          function At(e, t) {
            ...
            return null === n
              ? null
              : 0 === (s = 60 * (a = ((n[n.length - 1] || []) + '').match(Wt) || ['-', 0, 0])[1] + Q(a[2]))
              ? 0
              : '+' === a[0]
              ? s
              : -s;
          ...
          function Et(e, t) {
            ...
            return t._isUTC
              ? ((a = t.clone()),
                (s = (D(e) || m(e) ? e.valueOf() : Tt(e).valueOf()) - a.valueOf()),
            ...
            return (
              xt(e)
                ...
                : 'object' == typeof o &&
                  ...
                  (o.M = n.months)),
              (s = new jt(o)),
              xt(e) && d(e, '_locale') && (s._locale = e._locale),
              xt(e) && d(e, '_isValid') && (s._isValid = e._isValid),
              s
            );
          }
          function Jt(e, t) {
          ...
          function da(e, t, a, s, n) {
            var r;
            return null == e ? Fe(this, s, n).year : (t > (r = ze(e, s, n)) && (t = r), _a.call(this, e, t, a, s, n));
          }
          ...
          E('N', 0, 0, 'eraAbbr'),
            ...
            fe(['N', 'NN', 'NNN', 'NNNN', 'NNNNN'], function (e, t, a, s) {
            ...
            fe(['y', 'yy', 'yyy', 'yyyy'], 0),
            fe(['yo'], function (e, t, a, s) {
              var n;
              a._locale._eraYearOrdinalRegex && (n = e.match(a._locale._eraYearOrdinalRegex)),
                (t[0] = a._locale.eraYearOrdinalParse ? a._locale.eraYearOrdinalParse(e, n) : parseInt(e, 10));
            }),
            E(0, ['gg', 2], 0, function () {
            ...
            he('GGGGG', _e, ae),
            he('ggggg', _e, ae),
            pe(['gggg', 'ggggg', 'GGGG', 'GGGGG'], function (e, t, a, s) {
              t[s.substr(0, 2)] = Q(e);
            }),
            pe(['gg', 'GG'], function (e, t, a, s) {
          ...
          (Ma.add = Gt),
            ...
            (Ma.diff = function (e, t, a) {
              ...
              switch (((n = 6e4 * (s.utcOffset() - this.utcOffset())), (t = C(t)))) {
                case 'year':
                  r = Kt(this, s) / 12;
                  break;
                case 'month':
            ...
            (Ma.get = function (e) {
              return S(this[(e = C(e))]) ? this[e]() : this;
            }),
            ...
            (Ma.isBetween = function (e, t, a, s) {
              ...
              return (
                ...
                ('(' === (s = s || '()')[0] ? this.isAfter(n, a) : !this.isBefore(n, a)) &&
            ...
            (Ma.isSame = function (e, t) {
              ...
              return (
                ...
                ('millisecond' === (t = C(t) || 'millisecond')
                  ...
                  : ((a = s.valueOf()), this.clone().startOf(t).valueOf() <= a && a <= this.clone().endOf(t).valueOf()))
              );
            }),
            ...
            (Ma.inspect = function () {
              ...
              var e,
                ...
                s = '';
              return (
                this.isLocal() || ((a = 0 === this.utcOffset() ? 'moment.utc' : 'moment.parseZone'), (s = 'Z')),
                (e = '[' + a + '("]'),
                (t = 0 <= this.year() && this.year() <= 9999 ? 'YYYY' : 'YYYYYY'),
                this.format(e + t + '-MM-DD[T]HH:mm:ss.SSS' + s + '[")]')
              );
            }),
            ...
            (Ma.eraNarrow = function () {
              var e,
                ...
                s = this.localeData().eras();
              for (e = 0, t = s.length; e < t; ++e) {
                if (((a = this.clone().startOf('day').valueOf()), s[e].since <= a && a <= s[e].until))
                  return s[e].narrow;
          ...
          function fa(e, t, a) {
            ...
            var s,
              n = [];
            for (s = 0; s < 12; s++) n[s] = ya(e, s, a, 'month');
            return n;
          }
          function pa(e, t, a, s) {
            'boolean' == typeof e
            ...
            var n,
              ...
              i = e ? r._week.dow : 0,
              d = [];
            if (null != a) return ya(t, (a + i) % 7, s, 'day');
            for (n = 0; n < 7; n++) d[n] = ya(t, (n + i) % 7, s, 'day');
            return d;
          }
          (Ya.calendar = function (e, t, a) {
            ...
            (Ya.preparse = La),
            (Ya.postformat = La),
            (Ya.relativeTime = function (e, t, a, s) {
            ...
            (Ya.erasParse = function (e, t, a) {
              ...
              for (e = e.toUpperCase(), s = 0, n = _.length; s < n; ++s)
                if (((r = _[s].name.toUpperCase()), (i = _[s].abbr.toUpperCase()), (d = _[s].narrow.toUpperCase()), a))
                  switch (t) {
                    case 'N':
                    case 'NN':
                    case 'NNN':
            ...
            (n.lang = w('moment.lang is deprecated. Use moment.locale instead.', it)),
            (n.langData = w('moment.langData is deprecated. Use moment.localeData instead.', _t));
          var ka = Math.abs;
          function Da(e, t, a, s) {
            var n = Ct(t, a);
            return (
          ...
          return (
            ...
            (Za.as = function (e) {
              ...
              if ('month' === (e = C(e)) || 'quarter' === e || 'year' === e)
                switch (((a = this._months + wa((t = this._days + s / 864e5))), e)) {
                  case 'month':
                    return a;
                  case 'quarter':
                    return a / 3;
