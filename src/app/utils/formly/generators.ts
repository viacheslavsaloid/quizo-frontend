...
import { AppFormlyField, GenerateFormlyFieldsArgs } from 'app/models/utils/formly.model';
import { FORMLY_MODELS } from './models';

export const getFormlyModelByName = (name: string) => FORMLY_MODELS[name];
...
export function generateFormlyFields(args: GenerateFormlyFieldsArgs): Array<FormlyFieldConfig> {
  ...
  const fields = typeof args.fields === 'string' ? getFormlyModelByName(args.fields) : args.fields;
